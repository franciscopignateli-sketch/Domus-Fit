...
function Exercises() {
  ...
  // Base de dados local de exercícios atualizada com os teus GIFs animados!
  const exerciseData = {
    peito: [
      {
      ...
      },
      {
        ...
        img: "https://image.tuasaude.com/media/article/ly/ur/exercicios-para-peitoral_73975.gif?width=686&height=487", // LINK CORRIGIDO AQUI
        steps: [
    ...
    abdominal: [
      ...
      },
      {
        ...
        steps: [
          "Deita-te de barriga para cima com as pernas esticadas e as manos sob os glúteos para proteção.",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {exerciseData[activeTab].map((ex, index) => (
            <div key={index} className="bg-gym-dark rounded-xl border border-white/10 overflow-hidden shadow-2xl flex flex-col transition-all duration-300 hover:border-white/20">
              ...
              {/* BOX DO GIF ATUALIZADO (Aumentado para h-80 e ajustado para conter o GIF completo) */}
