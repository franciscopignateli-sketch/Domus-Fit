...
function About() {
  ...
  useEffect(() => {
    // Flag de montagem para prevenir atualizações de estado em componentes desmontados 
    // caso a navegação ocorra antes da resposta da API.
    let isMounted = true;
    ...
    const getTrainers = async () => {
      try {
        ...
        if (isMounted) {
          console.error("Erro na API de treinadores:", error);
          setIsLoading(false);
        }
      }
    };
          ...
          <div className="mt-20 md:mt-24">
            ...
            {isLoading ? (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
                {/* Substituição do uso do índice pela chave primária (id) para otimização da Virtual DOM do React */}
