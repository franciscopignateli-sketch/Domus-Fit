...
function TrainerPanel() {
  ...
  useEffect(() => {
    ...
    // Verificação de segurança adicional no lado do cliente para evitar acessos indevidos por manipulação de localStorage
    ...
    // Controlo do ciclo de vida do componente para chamadas assíncronas
    let isMounted = true;
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        {isLoading ? (
          ...
          <div className="bg-gym-dark p-8 rounded-xl border border-white/5 text-center">
            <p className="text-gray-400">Não tens nenhuma aula agendada de momento. Aproveita o descanso!</p>
          </div>
        ) : (
